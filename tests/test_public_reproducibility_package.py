...
def test_slim_publication_files_exist():
    required = [
        ...
        ROOT / "paper2_submission_source/figures/paper2_illustrative_rotation_curves.pdf",
        ROOT / "figures/paper2_projection_rms_distribution.pdf",
        ROOT / "figures/paper2_baseline_auc_comparison.pdf",
        ROOT / "figures/paper2_error_audit.pdf",
        ROOT / "figures/paper2_confusion_matrix.pdf",
        ROOT / "figures/paper2_projection_roc.pdf",
        ROOT / "figures/paper2_distance_stress.pdf",
        ROOT / "figures/paper2_auc_stability_distributions.pdf",
        ROOT / "figures/paper2_illustrative_rotation_curves.pdf",
